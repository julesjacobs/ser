...
\input{sections/9_appendix_a_invariant_example}
\input{sections/9_appendix_b_more_NS_examples}
\input{sections/9_appendix_c_bidirectional_optimization_proof.tex}
