...
\input{2_problem_definition.tex}
\input{3_netkat_with_global_variables.tex}
\input{4_formulations.tex}
\input{5_proofs.tex}
\input{6_implementation.tex}
\input{7_related_work.tex}
\input{8_discussion.tex}
