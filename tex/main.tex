...
%	to dramatically reduce the search space. We integrate these techniques into a working implementation and evaluate it on a benchmark suite of dozens of complex examples 
