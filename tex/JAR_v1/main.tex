...
\begin{document}
	...
	\title{\centering Verifying Unbounded Serializability in\\ Network Systems}
	...
	\maketitle
	\section*{Funding and Author Contribution}
	The work of Amir was
	partially supported by a Rothschild Fellowship from Yad Hanadiv (The Rothschild Foundation).
	%
	The main algorithm was developed by G.A., M.B., and J.J., who also developed the main toolchain.
	The Petri net model checking was led by N.A., and based on SMPT.
	All four authors  (G.A., M.B., N.A., and J.J.) contributed to writing the paper and running the evaluation.
...
%	\thispagestyle{plain}
	...
	\input{sections/11_appendix_more_NS_examples}
	\input{sections/11_appendix_NS_to_PN_formulation}
	\input{sections/11_appendix_serializable_program_proof_example}
	\input{sections/11_appendix_bidirectional_optimization_proof.tex}
