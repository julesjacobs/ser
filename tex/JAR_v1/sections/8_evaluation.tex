...
\begin{table}[t]
	...
	\caption{Certificate generation runtime (\texttt{cert.}) and the overall runtime (\texttt{total}), including for the validation phase.}
...
\medskip
\noindent
\textbf{Median and average runtime.} 
%
...
%
This is unsurprising, since validating a candidate counterexample amounts to a polynomial-time simulation of the network system to confirm its feasibility.
%
