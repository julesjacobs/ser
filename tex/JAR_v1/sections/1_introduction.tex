...
\begin{enumerate}
	...
	\item
	We extensively evaluate all four optimizations, demonstrating that our optimizations indeed reduce the space and time complexity by orders of magnitude, as presented by experiments that were not included in the main text of our TACAS proceedings paper.
	
	\item 
	We elaborate on all the test suite programs, including both serializable and non-serializable benchmarks.
	
	\item 
	We formalize the translation of network systems models to Petri nets representing interleaved programs.
