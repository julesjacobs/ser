...
%
Elmas et al.~\cite{ElQaSeSuTa10} also use the notion of movers and present a technique to prove linearizability by iteratively rewriting an input program.
