...
\todo{5 papers (OOPSLA 2024 + another 4) from the slack DM channel with Mark}
...
e.g.~\cite{CoDoGr05, DeScWe11}. Additional related work includes~\cite{EnKo24}.
%
...
Petri Net research~\cite{Mu89, Es96, Re12, EsNi24}. The undecidability we prove 
...
%
Furthermore, our approach also builds on Petri Net reachability algorithms, 
