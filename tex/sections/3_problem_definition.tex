...
\begin{proof}
	...
	\medskip\noindent
	\textbf{Case 1: Global state \textcolor{blue}{[L=0,X=0]}.}
	The projection is
	\[
	...
	e_{5}=e_{1},\;
	e_{4}=e_{1},\;
	\text{\color{ForestGreen}$\blacklozenge_{\text{main}}$}/\text{\color{red}$\blacklozenge_{1}$}=e_{1},\;
	e_{3}=e_{0},\;
	\text{\color{ForestGreen}$\blacklozenge_{\text{main}}$}/\text{\color{red}$\blacklozenge_{0}$}=e_{0},
	\]
	and
	\[
	...
	=0,
	\]
	so no request from \(\text{\color{ForestGreen}$\blacklozenge_{\text{main}}$}/\text{\color{red}$\blacklozenge_{0}$}\) exists in state
	\textcolor{blue}{[L=0,X=0]}.
	
	\medskip\noindent
	\textbf{Case 2: Global state \textcolor{blue}{[L=1,X=1]}.}
	The projection is
	\[
	\bigl(\,\text{\color{ForestGreen}$\blacklozenge_{\text{main}}$}/\text{\color{red}$\blacklozenge_{0}$},\;
	\text{\color{ForestGreen}$\blacklozenge_{\text{main}}$}/1\bigr)
	\;\mapsto\;
	\exists\,e_{0},\dots,e_{5}.\;\bot,
	\]
	which is unsatisfiable.  Hence no completed‐request pair—and in particular no \(\text{\color{ForestGreen}$\blacklozenge_{\text{main}}$}/\text{\color{red}$\blacklozenge_{0}$}\)—can occur in this state.
