...
Our network system (NS) syntax is defined as described in the following syntax: 
...
\begin{aligned}
	...
	&x := e
	&&\grammartag{Write to local variable field}\\
	&x
	&&\grammartag{Read from local variable field}\\
	&X := e
