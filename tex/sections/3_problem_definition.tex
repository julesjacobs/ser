...
\begin{mathpar}
	\inferrule*[right=YIELD]{\cfg{e}{\ell}{g} \step \cfg{\yieldkw \cdot e'}{\ell'}{g'}}{\langle g , \Pi \cup \{(e,\ell)\}\rangle \pstep \langle g' , \Pi \cup \{(e',\ell')\}\rangle}
	\\
	\inferrule*[right=SPAWN]{\requestkw\ name_i\{e_i\}\quad i\in\{1,\dots,n\}}{\langle g \mid \Pi\rangle \pstep \langle g \mid \Pi \cup \{(e_i,\ell_0)\}\rangle}
	\and
	\inferrule*[right=TERMINATE]{\cfg{e}{\ell}{g} \step \cfg{v}{\ell'}{g'} \quad v\in\mathbb{N}}{\langle g \mid \Pi \cup \{(e,\ell)\} \rangle \pstep \langle g' \mid \Pi\rangle}	
\end{mathpar}
