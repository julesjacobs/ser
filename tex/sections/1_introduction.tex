...
\noindent
% Left column (two stacked listings)
...
%	\begin{lstlisting}[caption={Request Foo A}]
%		request foo { 
%			
%			X := 1 
%			  
...
%\hfill
%\begin{minipage}[t]{0.28\textwidth}
%	\begin{lstlisting}[caption={Request Foo B}]
%		request foo {
%			 
%			X := 1 
%			yield 
...
%\hfill
%\begin{minipage}[t]{0.28\textwidth}
%	\begin{lstlisting}[caption={Request Foo C}]
%		request foo { 	
%		
%			while (L == 1) 
%				yield
