...
\todo{snapshot\_isolation\_directly\_as\_NS\_with\_yields}
\begin{figure}[h]
	\centering
\includegraphics[width=0.65\linewidth]{plots/snapshot\_isolation\_JSON\_without\_yields.pdf}
...
\todo{snapshot\_isolation\_directly\_as\_NS\_without\_yields}
