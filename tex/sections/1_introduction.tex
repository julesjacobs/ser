...
In this work, we begin bridging these gaps, and present an end-to-end tool to verify whether an arbitrary transactional program is provably serializable.
