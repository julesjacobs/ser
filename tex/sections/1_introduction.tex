...
In this work, be begin bridging these gaps, and present the first end-to-end tool to verify whether an arbitrary transactional program is provably serializable.  
...
Building upon the previous theoretical work of deciding serializability, as well as the state-of-the-art in PN model checkers, we see this work as an important step in practical reasoning about concurrent programs in general, and about serializability in particular.
