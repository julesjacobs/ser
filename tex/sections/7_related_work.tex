...
%
Our implementation leverages \texttt{SMPT}~\cite{AmDa23}, a state-of-the-art model checker for reachability problems in Petri nets (for additional details, see Appendix~\ref{appendix:smpt}). However, our tool can also be compatible with other PN model checkers as well.
