...
Typically, automatically generated $\toolname$ programs do not represent real-world applications or recognizable concurrency patterns. Thus, we curated what we believe is the first benchmark suite for serializability in this setting, aiming to connect \toolname{} programs to practical, real-world analogues.
% additional part (from rebuttal to R4) - END
