...
Since automatically generating a syntactically-valid $\toolname$ program typically does not yield programs representative of real-world applications or recognizable concurrency patterns, we curated what we believe is the first benchmark suite for serializability in this setting, aiming to connect the programs to practical, real-world analogues.
% additional part (from rebuttal to R4) - END
