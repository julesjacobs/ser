...
\begin{abstract}
	...
	%
	We also present a network-system program abstraction to which \toolname{} programs compile. Our decision procedure then reduces serializability in this setting to a Petri net reachability query. 
	%
	...
	%
	We extensively evaluate our framework and show that, despite the theoretical hardness of the problem, it can successfully handle various real-world programs, including stateful firewalls, BGP routers, and more.
\end{abstract}
