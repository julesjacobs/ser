...
\begin{abstract}
	...
	%
	Building on prior theoretical results for this setting, we give the first automated end-to-end decision procedure that either proves serializability by producing a checkable certificate, or refutes it by producing a counterexample trace.
	%
