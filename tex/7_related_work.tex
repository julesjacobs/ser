...
Furthermore, our work builds on both theoretical and practical advances in Petri net research~\cite{Mu89, Es96, Re12, EsNi24}. The undecidability we prove for equivalence of interleavings stems from Hack’s seminal result~\cite{Ha76, HaThesis76} showing the undecidability of reachability set equivalence for Petri Nets --- a result inspired by similar (unpublished) work by M. Rabin. This undecidability originates in a series of reductions from Hilbert’s 10th problem, specifically the impossibility of determining integer roots for Diophantine equations (established as undecidable by Matijasēvič~\cite{Ma70}).
%
