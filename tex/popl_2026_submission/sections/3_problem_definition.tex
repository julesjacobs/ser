...
%
Furthermore, we note that our syntax and semantics can both be extended to include \textit{arithmetic operations} in a straightforward manner, however, we omit these for simplicity. 
