...
mod tests {
    ...
    fn test_escape_for_graphviz_id() {
        ...
        assert_eq!(string::escape_for_graphviz_id("already_valid"), "already_valid");
        assert_eq!(string::escape_for_graphviz_id("123abc"), "123abc");
        assert_eq!(string::escape_for_graphviz_id("special!@#$%"), "special_____");
    }
    ...
    fn test_html_escape() {
        ...
        assert_eq!(string::html_escape("'apostrophe'"), "&#x27;apostrophe&#x27;");
    }
