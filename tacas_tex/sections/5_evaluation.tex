...
\begin{table}[htbp]
	...
	\caption{Overview of the benchmark containing networking and system protocols. For our full benchmarks ee Appendix~\ref{appendix:full_results}.}
...
%
For example, there are instances such as \texttt{a3.ser} and \texttt{a7.ser}, in which the use of the redundant constraint optimization (  [\texttt{\textbf{\text{-}\text{R}\text{-}\text{-}}}])
