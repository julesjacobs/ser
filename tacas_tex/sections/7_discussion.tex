...
First, the underlying Petri net reachability problem has \texttt{Ackermann}-complete complexity~\cite{CzWo22}, causing our tool to time out on some complex benchmarks. %despite optimizations.
