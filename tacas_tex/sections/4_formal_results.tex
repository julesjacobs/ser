...
%	\item \textbf{Reachability encoding.}  
	...
	\begin{itemize}
		...
		for \(\mathcal S\).
		%
		This is validated by synthesizing an inductive invariant over the interleaving PN, thereby proving that the corresponding semilinear set cannot be realized by any interleaving.
		See the example in Appendix~\ref{appendix:ns-serializable}.
	\end{itemize}
