...
\newpage
\input{sections/9_appendix_tour}
\input{sections/9_appendix_ser_semantics}
\input{sections/9_appendix_more_NS_examples}
\input{sections/9_appendix_delta_req_resp_example}
\input{sections/9_appendix_NS_to_PN_formulation}
\input{sections/9_appendix_serializable_program_proof_example}
\input{sections/9_appendix_non_serializable_execution_counterexample}
